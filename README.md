# bigdata-top10products

This is a exploratory project to make use of big data techniques to process a large set of documents and derive aggregated measures. In this case, we are finding the price for the top 10 reviewed products.
